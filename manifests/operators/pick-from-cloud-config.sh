...
# The base manifests/redis-debian.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/redis-debian.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
